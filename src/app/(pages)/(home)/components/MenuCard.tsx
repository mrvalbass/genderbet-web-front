...
export default function MenuCard({
  ...
  return (
    ...
    >
      <div className=" from-[#000000AA] bg-gradient-to-t w-full h-full rounded-lg backdrop-blur-[2px] flex flex-col justify-center md:justify-end items-start text-orange-100">
        <p className="text-3xl font-bold pl-10">{children}</p>
        <p className="text-lg px-10 md:pb-10">
